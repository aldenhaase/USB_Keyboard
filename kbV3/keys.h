...
#define KEY_LAYER_UP 0x1001
#define KEY_LAYER_DOWN 0x1004
#define KEY_QUICK_FN 0x1002
...
#define KEY_LEFTCTRL (KEY_MOD_LCTRL | KEY_MOD_MACRO)  // Keyboard Left Control
#define KEY_LEFTSHIFT (KEY_MOD_LSHIFT | KEY_MOD_MACRO) // Keyboard Left Shift
#define KEY_LEFTALT (KEY_MOD_LALT | KEY_MOD_MACRO)  // Keyboard Left Alt
#define KEY_LEFTMETA 0xe3 // Keyboard Left GUI
#define KEY_RIGHTCTRL (KEY_MOD_RCTRL | KEY_MOD_MACRO)  // Keyboard Right Control
#define KEY_RIGHTSHIFT (KEY_MOD_RSHIFT | KEY_MOD_MACRO)  // Keyboard Right Shift
#define KEY_RIGHTALT (KEY_MOD_RALT | KEY_MOD_MACRO)  // Keyboard Right Alt
